...
export const DottedGlowBackground = ({
  ...
  useEffect(() => {
    ...
    const compute = () => {
      ...
      if (isDark) {
        const varDot = resolveCssVariable(container as Element, colorDarkVar);
        const varGlow = resolveCssVariable(container as Element, glowColorDarkVar);
        nextColor = varDot || darkColor || nextColor;
        nextGlow = varGlow || darkGlowColor || nextGlow;
      } else {
        const varDot = resolveCssVariable(container as Element, colorLightVar);
        const varGlow = resolveCssVariable(container as Element, glowColorLightVar);

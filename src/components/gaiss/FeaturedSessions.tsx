...
const sessions = [
  {
    ...
    description: "Learn how to design intuitive interfaces powered by real-time AI responses.",
    speaker: "Ava Mitchell",
    org: "Interface Labs",
    image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=100&q=80",
  },
  {
    title: "Web3 Infrastructure in Action",
    time: "2:00 PM",
    type: "Panel Discussion",
    description: "Shift security left in your pipeline with modern tools and practices.",
    speaker: "Rajan Verma",
    org: "CloudEdge",
    image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&q=80",
  },
  {
    title: "Scaling Systems with CloudEdge",
    time: "1:30 PM",
    type: "Tech Talk",
    description: "Explore cloud infrastructure strategies for building high-performance global apps.",
    speaker: "Emily Chen",
    org: "Arverse",
    image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=100&q=80",
  },
  {
    title: "Designing for AR & Spatial UX",
    time: "11:00 AM",
    type: "Design Session",
    description: "Create immersive AR experiences that blend digital and physical worlds.",
    speaker: "Carlos Rios",
    org: "CyberForge",
  ...
  {
    title: "The Future of Product Velocity",
    time: "12:00 PM",
    type: "Closing Keynote",
    description: "Unlocking speed, scale, and innovation in modern product teams.",
    speaker: "Leo Anders",
    org: "DEVSphere",
